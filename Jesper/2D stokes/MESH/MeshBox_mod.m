...
%       type    1: for GLL spaced grid 2: gauss legendre grid
%               3: for regular spaced grid
%
...
%
function [iglob,x,y]=MeshBox_mod(LX,LY,NELX,NELY,NGLL,type)
...
for ey=1:NELY,
    for ex=1:NELX,
        ...
        elseif type == 2
            ig = reshape([1:NGLL*NGLL],NGLL,NGLL)+last_iglob;
        end
        iglob(:,:,e) = ig;
