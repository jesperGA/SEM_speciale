function [A, B, grad1, grad2, gradgrad1, gradgrad2] = elementMatrix2D(x, y, xi, w, D, DD, N)
    ...
    gradgrad1 = zeros(ldof_u, ldof_u);
    gradgrad2 = zeros(ldof_u, ldof_u);
    ...
    gradgrad = calculateGradient(xr, xs, yr, ys, DD, N);
        ...
        for j = 1:N + 1
            for m = 1:N + 1
                for n = 1:N + 1
                    ...
                    gradgrad1(row, col) = 2/J(i,j)*gradgrad(i, j, m, n, 1);
                    gradgrad2(row, col) = 2/J(i,j)*gradgrad(i, j, m, n, 2);
                end
            end
        end
    end
