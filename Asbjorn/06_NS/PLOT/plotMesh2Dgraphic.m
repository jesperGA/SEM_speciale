...
ObjectCoords = study.ObjectCoords;
...
if length(ObjectCoords)==4 % square
    ...
    scatter(mesh.X(mesh.Object_nodes,2),mesh.X(mesh.Object_nodes,3),'.','SizeData', SzData, 'MarkerEdgeColor', defaultColors(2,:),'HandleVisibility', 'off')
